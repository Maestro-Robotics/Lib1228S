...
pros::Motor rM(5, pros::E_MOTOR_GEARSET_06); // right middle motor. port 11
pros::Motor rB(4, pros::E_MOTOR_GEARSET_06); // right back motor. port 13
...
void autonomous() {
    ...
    chassis.turnToPoint(45, -45, 1000, true);
    ...
    chassis.swingToAngle(180, false, 2000, false);
